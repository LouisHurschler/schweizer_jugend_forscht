...
class BoxHandler:
    ...
    def _on_message(self, client, userdata, message):
        ...
        def calc_power(
            current: list, voltage: list, energy: list, power_factor: list, timestamp
        ) -> pd.DataFrame:
            data_tmp = {}
            for i in range(3):
        ...
        current_list = [
            timespanLog.L1_current_average / 1000,
            timespanLog.L2_current_average / 1000,
            timespanLog.L3_current_average / 1000,
        ]
        voltage_list = [
            timespanLog.L1_voltage_average / 1000,
            timespanLog.L2_voltage_average / 1000,
            timespanLog.L3_voltage_average / 1000,
        ]
        energy_list = [
            timespanLog.L1_apparent_energy,
            timespanLog.L2_apparent_energy,
            timespanLog.L3_apparent_energy,
        ]
        power_factor_list = [
            timespanLog.L1_power_factor_average / 1000,
